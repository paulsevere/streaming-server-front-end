...
(function() {
    ...
    g.prototype._receive_input = function(a, c) {
        ...
        if (this._prevent_capture) this._keys_down.length &&
            (this._keys_down = []);
        else if (b = z(null != (d = a.keyCode) ? d : a.key), (c || this._keys_down.length || !("alt" === b || b === o)) && b) return c ? this._key_down(b, a) : this._key_up(b, a)
    };
    ...
    g.prototype._handle_combo_down = function(a, c, b, d) {
        ...
        if (a.is_exclusive) {
            ...
            for (m = c.length; g < m; g++)
                if (f = c[g], f.is_exclusive && f.keys.length >
                    a.keys.length) {
                    b = !0;
                    break
                }
    ...
    g.prototype._handle_combo_up = function(a, c, b) {
        ...
        if (!a.keyup_fired && (d = this._keys_down.slice(),
                d.push(b), !a.is_solitary || v(d, a.keys))) this._fire("keyup", a, c), a.is_counting && ("function" === typeof a.on_keyup && "function" !== typeof a.on_keydown) && (a.count += 1);
    ...
    g.prototype.unregister_many = function(a) {
        ...
        e = [];
        b = 0;
        for (d = a.length; b < d; b++) c =
            a[b], e.push(this.unregister_combo(c));
        return e
    };
    ...
    I = function(a) {
        ...
        b = g = 0;
        for (i = a.keys.length; 0 <= i ? g < i : g > i; b = 0 <= i ? ++g : --g) d = a.keys[b], (c = H[d]) &&
            (d = a.keys[b] = c), "meta" === d && a.keys.splice(b, 1, o), "cmd" === d && p('Warning: use the "meta" key rather than "cmd" for Windows compatibility');
        i = a.keys;
        c = 0;
        ...
        for (e in a) "undefined" === r[e] && p("The property " +
            e + " is not a valid combo property. Your combo has still been registered.");
        return f
    };
    A = function(a, c) {
        var b;
